...
x = sys.argv[1:]
# x = ['Sunderland x Norwich City - P1 (LCH) - 27/08 - 08:30', 'Blackburn Rovers x Stoke City - P1 (LCH) - 27/08 - 11:00', 'Blackpool x Bristol City - P1 (LCH) - 27/08 - 11:00', 'Cardiff City x Preston North End - P1 (LCH) - 27/08 - 11:00', 'Middlesbrough x Swansea City - P1 (LCH) - 27/08 - 11:00', 'Millwall x Reading - P1 (LCH) - 27/08 - 11:00', 'Watford x Queens Park Rangers - P1 (LCH) - 27/08 - 11:00', 'Huddersfield Town x West Bromwich Albion - P1 (LCH) - 27/08 - 11:00', 'Hull City x Coventry City - P1 (LCH) - 27/08 - 11:00', 'Rotherham United x Birmingham City - P1 (LCH) - 27/08 - 11:00', 'Wigan Athletic x Burnley - P1 (LCH) - 27/08 - 11:00']
	...
	if index % 2 == 0:
		...
		if rows[0][4] >= 1:
			...
			if rows[0][4] <=11:
				...
				temp_classi.append([int(positionto_1),int(positionto_1_2)])
			...
			for indx in range(zx):
				if indx%2 == 0:
					if temp0_sorted[indx] == temp0_sorted[indx+1]:
						if min(temp_classi_sorted[indx][0], temp_classi_sorted[indx][1]) > min(temp_classi_sorted[(indx+1)][0], temp_classi_sorted[(indx+1)][1]):
							a, b, c, d = temp0_sorted[indx], x_sorted[indx], temp_classi_sorted[indx][0], temp_classi_sorted[indx][1]
							temp0_sorted[indx], x_sorted[indx], temp_classi_sorted[indx][0], temp_classi_sorted[indx][1] = temp0_sorted[indx+1], x_sorted[indx+1], temp_classi_sorted[indx+1][0], temp_classi_sorted[indx+1][1]
							temp0_sorted[indx+1], x_sorted[indx+1], temp_classi_sorted[indx+1][0], temp_classi_sorted[indx+1][1] = a, b, c, d
