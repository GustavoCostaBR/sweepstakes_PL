...
x = ['Time1 x Time10 - P1 (PL) - 20/05 - 08:30', 'Time2 x Time15 - P1 (PL) - 20/05 - 08:30', 'Time3 x Time4 - P3 (PL) - 20/05 - 08:30','Time5 x Time6 - P3 (PL) - 20/05 - 08:30','Time7 x Time17 - P1 (PL) - 20/05 - 08:30','Time8 x Time14 - P1 (PL) - 20/05 - 08:30','Time9 x Time13 - P1 (PL) - 20/05 - 08:30','Time11 x Time12 - P1 (PL) - 20/05 - 08:30','Time16 x Time20 - P1 (PL) - 20/05 - 08:30','Time18 x Time19 - P3 (PL) - 20/05 - 08:30']
...
for index, j in enumerate(temp):
	...
	if index % 2 == 0:
		...
		# critehrio da zona de rebaixamento
		# OS DOIS TIMES DENTRO SEPARADOS DO PRIMEIRO FORA DELA POR ATÉ 3 PONTOS
				elif (0 >= p(0, index, 16) >= (-3) and 0 >= p(0, index+1, 16) >= (-3)) and (p(1, index, 16) >= 1 and p(1, index+1, 16) >= 1) and (p(2, index, 16) >= (-7) and p(2, index+1, 16) >= (-7)):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

				elif (0 >= p(0, index, 16) >= (-2) and 0 >= p(0, index+1, 16) >= (-2)) and (p(1, index, 16) >= 1 and p(1, index+1, 16) >= 1):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

			# UM DENTRO E OUTRO FORA SEPARADOS POR ATÉ 3 PONTOS
				elif  (p(1, index, 17) >= 0 and 0 <= (p(0, index+1, 0)-p(0, index, 0)) <= 3 and (p(2, index+1, 0)-p(2, index, 0)) <= 7 and p(1, index+1, 17) <0) or (p(1, index+1, 17) >= 0 and 0 <= (p(0, index, 0)-p(0, index+1, 0)) <= 3 and (p(2, index, 0)-p(2, index+1, 0)) <= 7 and p(1, index, 17) <0):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

				elif  (p(1, index, 17) >= 0 and 0 <= (p(0, index+1, 0)-p(0, index, 0)) <= 2 and p(1, index+1, 17) <0) or (p(1, index+1, 17) >= 0 and 0 <= (p(0, index, 0)-p(0, index+1, 0)) <= 2 and p(1, index, 17) <0):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

			# OS DOIS FORA COM ATÉ 3 PONTOS PARA ENTRAR NA ZONA DA DEGOLA
				elif(p(1, index, 16) <= 0 and p(1, index+1, 16) <= 0) and (p(0, index, 17) <= 3 and p(0, index+1, 17) <= 3) and (p(2, index, 17) <= 7 and p(2, index+1, 17) <= 7):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

				elif(p(1, index, 16) <= 0 and p(1, index+1, 16) <= 0) and (p(0, index, 17) <= 2 and p(0, index+1, 17) <= 2):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")
			...
			# critehrio do champions
			# OS DOIS TIMES DENTRO SEPARADOS DO PRIMEIRO FORA DELA POR ATÉ 3 PONTOS
				elif (0 <= p(0, index, 4) <=3 and 0 <= p(0, index+1, 4) <= 3) and (p(2, index,3) >= 7 and p(2, index+1, 3) >= 7) and p(1, index, 4) < 0 and p(1, index+1, 4) < 0:
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

				elif (0 <= p(0, index, 4) <=2 and 0 <= p(0, index+1, 4) <= 2) and p(1, index, 4) < 0 and p(1, index+1, 4) < 0:
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

			# UM DENTRO E OUTRO FORA SEPARADOS POR ATÉ 3 PONTOS
				elif  (1 < p(1, index, 0) < 4 and 0 <= (p(0, index, 0)-p(0, index+1, 0)) <= 3 and (p(2, index, 0)-p(2, index+1, 0)) <= 7 and p(1, index+1, 0) >= 4) or (1 < p(1, index+1, 0) < 4 and 0 <= (p(0, index+1, 0)-p(0, index, 0)) <= 3 and (p(2, index+1, 0)-p(2, index, 0)) <= 7 and p(1, index, 0) >= 4):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

				elif  (1 < p(1, index, 0) < 4 and 0 <= (p(0, index, 0)-p(0, index+1, 0)) <= 2 and p(1, index+1, 0) >= 4) or (1 < p(1, index+1, 0) < 4 and 0 <= (p(0, index+1, 0)-p(0, index, 0)) <= 2 and p(1, index, 0) >= 4):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")
			...
			# OS DOIS TIMES DENTRO SEPARADOS DO PRIMEIRO FORA DELA POR ATÉ 3 PONTOS
				elif (0 <= p(0, index, 6) <=3 and 0 <= p(0, index+1, 6) <= 3) and (p(2, index,3) >= 7 and p(2, index+1, 3) >= 7) and p(1, index, 6) < 0 and p(1, index+1, 6) < 0:
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

				elif (0 <= p(0, index, 6) <=2 and 0 <= p(0, index+1, 6) <= 2) and p(1, index, 6) < 0 and p(1, index+1, 6) < 0:
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")
			...
			# UM DENTRO E OUTRO FORA SEPARADOS POR ATÉ 3 PONTOS
				elif  (1 < p(1, index, 0) < 6 and 0 <= (p(0, index, 0)-p(0, index+1, 0)) <= 3 and (p(2, index, 0)-p(2, index+1, 0)) <= 7 and p(1, index+1, 0) >= 6) or (1 < p(1, index+1, 0) < 6 and 0 <= (p(0, index+1, 0)-p(0, index, 0)) <= 3 and (p(2, index+1, 0)-p(2, index, 0)) <= 7 and p(1, index, 0) >= 6):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")

				elif  (1 < p(1, index, 0) < 6 and 0 <= (p(0, index, 0)-p(0, index+1, 0)) <= 2 and p(1, index+1, 0) >= 6) or (1 < p(1, index+1, 0) < 6 and 0 <= (p(0, index+1, 0)-p(0, index, 0)) <= 2 and p(1, index, 0) >= 6):
					x[index//2] = x[index//2].replace("P1", "P3")
					x[index//2] = x[index//2].replace("P2", "P3")
