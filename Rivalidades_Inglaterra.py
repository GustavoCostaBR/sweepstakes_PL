...
'Brentford': ['Fulham', "Queen's Park Rangers"],
...
'Chelsea': ['Arsenal', 'Leeds United', 'Manchester United', 'Tottenham Hotspur', 'Fulham', "Queen's Park Rangers"],
...
'Fulham': ['Brentford', 'Chelsea', "Queen's Park Rangers"],
...
"Queen's Park Rangers": ['Brentford', 'Chelsea', 'Fulham'],
...
'West Ham United': ['Tottenham Hotspur', 'Millwall', 'Leyton Orient'], 'Wimbledon': ['Milton Keynes Dons'],
...
Rivalidades_Escocia = {
  'Aberdeen': ['Dundee United', 'Inverness Caledonian Thistle'],
  ...
  'Heart of Midlothian (Hearts)': ['Hibernian'],
  'Hibernian': ['Heart of Midlothian (Hearts)'],
  'Inverness Caledonian Thistle': ['Ross County', 'Aberdeen'],
...
Rivalidades = [Rivalidades_Inglaterra , Rivalidades_Escocia]

for x in Rivalidades_Inglaterra:
# 	print(x)
	if 'Darlington' in Rivalidades_Inglaterra[x]:
		print(x)
# print(Rivalidades[0]['Manchester United'][1])
