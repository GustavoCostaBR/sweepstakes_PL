...
# Start first program
result = subprocess.run(['python', 'buscador_jogosv3(sem funcao).py', *dt, *dt2, url_FACS], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
result2 = subprocess.run(['python', 'buscador_jogosv3(sem funcao).py', *dt, *dt2, url_PL], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
# # p1 = subprocess.Popen(['python', 'iniciador_de_string.py'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
if resultado < 33:
	# Start third program
	result3 = subprocess.run(['python', 'buscador_jogosv3(sem funcao).py', *dt, *dt2, url_SPFL], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
# print(Jogos)
	...
	temp=[]
	# Start third program
	result3 = subprocess.run(['python', 'buscador_jogosv3(sem funcao).py', *dt, *dt2, url_SPFL_championship], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
	...
	result3_2 = subprocess.run(['python', 'buscador_jogosv3(sem funcao).py', *dt, *dt2, url_SPFL_relegation], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
# # Remove the else for now for testing propose
	...
	result3 = subprocess.run(['python', 'buscador_jogosv3(sem funcao).py', *dt, *dt2, url_SPFL_PLAYOFFS], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
if resultado < 46:
	...
	result4 = subprocess.run(['python', 'buscador_jogosv3(sem funcao).py', *dt, *dt2, url_LCH], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
	# # p1 = subprocess.Popen(['python', 'iniciador_de_string.py'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
	...
	# # Start fourth program
	result4 = subprocess.run(['python', 'buscador_jogosv3(sem funcao).py', *dt, *dt2, url_LCH_PLAYOFFS], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
	# # p1 = subprocess.Popen(['python', 'iniciador_de_string.py'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
# # Start fifth program
result5 = subprocess.run(['python', 'buscador_jogosv3(sem funcao).py', *dt, *dt2, url_FAC], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
# # p1 = subprocess.Popen(['python', 'iniciador_de_string.py'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
